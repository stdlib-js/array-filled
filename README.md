...
```javascript
import filledarray from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-filled@v0.3.0-esm/index.mjs';
```
...
[@stdlib/array/filled-by]: https://github.com/stdlib-js/array-filled-by/tree/esm
